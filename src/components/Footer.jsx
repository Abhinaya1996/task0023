...
import { faPhoneAlt, faMapLocation, faMailBulk, faLocationPin } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className={footerstyles.footerwrapper}>
            ...
            <div className={footerstyles.row}>
                <div className={footerstyles.columnplain}>
                    <img src="/assets/elbrit-logo.jpg" style={{height:'80px' , width:'280px'}} alt="Logo" />
                </div>
                <div className={footerstyles.columnplain}>
